        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
                ...
                <div className="lg:col-span-2">
                    ...
                    <ul className="space-y-4 text-sm font-medium">
                        <li><Link href="/career-tips" className="hover:text-primary transition-colors">Career Tips</Link></li>
                        <li><Link href="/resume-builder" className="hover:text-primary transition-colors">Resume Builder</Link></li>
                        <li><Link href="/interview-guide" className="hover:text-primary transition-colors">Interview Guide</Link></li>
