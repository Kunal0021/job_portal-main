                       ...
                       <div className="flex flex-col md:flex-row gap-8">
                         ...
                         <div className="flex-1 space-y-4">
                           ...
                           <div className="flex flex-wrap gap-3">
                             <Badge className="bg-emerald-50 text-emerald-600 border-emerald-100 font-black text-[10px] px-3">{(!job.salary_range || job.salary_range.toLowerCase() === 'not available') ? 'To be Discussed' : job.salary_range}</Badge>
