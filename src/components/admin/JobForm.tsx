...
5. "description": HTML format. MIN 1000 words. MUST FOLLOW ALL CHECKLIST RULES:
    ...
    - Generate CLEAN, professional HTML. No empty paragraphs, no redundant line breaks between tags, and use compact semantic structure.
...
10. Output JSON schema: { "seo_title": "string", "meta_description": "string", "url_slug": "string", "content_html": "string", "focus_keyword": "string" }`
            },
            {
              role: 'user',
      ...
      const aiResponse = JSON.parse(jsonMatch ? jsonMatch[0] : content);
      ...
      alert('Failed to enhance checklist: ' + (error instanceof Error ? error.message : String(error)));
    } finally {
...
7. Generate CLEAN, professional HTML. Avoid empty paragraphs or excessive <br/> tags. Ensure text is compact and professional.`
            },
            {
              role: 'user',
      ...
      alert('Failed to enhance description: ' + (error instanceof Error ? error.message : String(error)));
    } finally {
                            ...
                            <div className="prose prose-slate max-w-none space-y-8 prose-p:my-3 prose-headings:mb-4">
                              <section>
                                ...
                                <div 
                                  ...
                                  dangerouslySetInnerHTML={{ __html: currentJob.description || '<p class="text-gray-400 italic">No description provided yet...</p>' }}
                                />
                              </section>
